        ...
        <ContentsDetail>
          <Scrollbars>
            ...
            <text>
              ...
              <br />
              <br />
              {"<"} 파이브이얼즈 {">"}('dzzdzz.me'이하 'dzzdzz')은(는)
              「개인정보 보호법」 제30조에 따라 정보주체의 개인정보를 보호하고
              이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여
              다음과 같이 개인정보 처리방침을 수립·공개합니다. ○ 이
              개인정보처리방침은 2022년 5월 4부터 적용됩니다. 제1조(개인정보의
              처리 목적)
              {"<"} 파이브이얼즈 {">"}('dzzdzz.me'이하 'dzzdzz')은(는) 다음의
              ...
              제공에 따른 본인 식별·인증, 서비스 부정이용 방지 목적으로
              개인정보를 처리합니다.
              <br />
              <br />
              2. 재화 또는 서비스 제공 서비스 제공을 목적으로 개인정보를
              처리합니다.
              <br />
              제2조(개인정보의 처리 및 보유 기간)
              <br />① {"<"} 파이브이얼즈 {">"}은(는) 법령에 따른 개인정보
              ...
              <br />
              제3조(처리하는 개인정보의 항목)
              <br />① {"<"} 파이브이얼즈 {">"}은(는) 다음의 개인정보 항목을
              처리하고 있습니다.
              <br />1{"<"} 홈페이지 회원가입 및 관리 {">"} 필수항목 : 이메일,
              휴대전화번호, 성별, 생년월일, 이름, 학력 선택항목 : 취미, 종교
              <br />
              <br />
              제4조(개인정보의 파기절차 및 파기방법)
              <br />① {"<"} 파이브이얼즈 {">"} 은(는) 개인정보 보유기간의 경과,
              ...
              <br />③ 개인정보 파기의 절차 및 방법은 다음과 같습니다. 1.
              파기절차 {"<"} 파이브이얼즈 {">"} 은(는) 파기 사유가 발생한
              개인정보를 선정하고, {"<"} 파이브이얼즈 {">"} 의 개인정보
              ...
              <br />① {"<"}개인정보처리자명{">"}은(는) 1년간 서비스를 이용하지
              않은 이용자의 정보를 파기하고 있습니다. 다만, 다른 법령에서 정한
              보존기간이 경과할 때까지 다른 이용자의 개인정보와 분리하여 별도로
              저장·관리할 수 있습니다. ② {"<"}개인정보처리자명{">"}은(는)
              개인정보의 파기 30일 전까지 개인정보가 파기되는 사실, 기간 만료일
              및 파기되는 개인정보의 항목을 이메일, 문자 등 이용자에게 통지
              가능한 방법으로 알리고 있습니다. ③ 개인정보의 파기를 원하지
              않으시는 경우, 기간 만료 전 서비스 로그인을 하시면 됩니다.
              <br />
              <br />
              제6조(정보주체와 법정대리인의 권리·의무 및 그 행사방법에 관한
              사항)
              <br />① 정보주체는 파이브이얼즈에 대해 언제든지 개인정보
              열람·정정·삭제·처리정지 요구 등의 권리를 행사할 수 있습니다.
              <br />② 제1항에 따른 권리 행사는파이브이얼즈에 대해 「개인정보
              보호법」 시행령 제41조제1항에 따라 서면, 전자우편, 모사전송(FAX)
              등을 통하여 하실 수 있으며 파이브이얼즈은(는) 이에 대해 지체 없이
              조치하겠습니다.
              ...
              <br />⑥ 파이브이얼즈은(는) 정보주체 권리에 따른 열람의 요구,
              ...
              있습니다.
              <br />
              4. 비인가자에 대한 출입 통제 개인정보를 보관하고 있는 물리적 보관
              ...
              관한 사항)
              <br />
              파이브이얼즈 은(는) 정보주체의 이용정보를 저장하고 수시로 불러오는
              ‘쿠키(cookie)’를 사용하지 않습니다.
              <br />
              <br />
              제9조 (개인정보 보호책임자에 관한 사항)
              <br />① 파이브이얼즈 은(는) 개인정보 처리에 관한 업무를 총괄해서
              책임지고, 개인정보 처리와 관련한 정보주체의 불만처리 및 피해구제
              등을 위하여 아래와 같이 개인정보 보호책임자를 지정하고 있습니다.
              <br />▶ 개인정보 보호책임자 성명 :박현주 직책 :- 직급 :- 연락처
              :-, dzzdzz.official@gmail.com, ※ 개인정보 보호 담당부서로
              연결됩니다.
              <br />▶ 개인정보 보호 담당부서 부서명 : 담당자 : 연락처 :, , ②
              정보주체께서는 파이브이얼즈 의 서비스(또는 사업)을 이용하시면서
              발생한 모든 개인정보 보호 관련 문의, 불만처리, 피해구제 등에 관한
              사항을 개인정보 보호책임자 및 담당부서로 문의하실 수 있습니다.
              파이브이얼즈 은(는) 정보주체의 문의에 대해 지체 없이 답변 및
              처리해드릴 것입니다.
              <br />
              <br />
              제10조(개인정보의 열람청구를 접수·처리하는 부서) 정보주체는
              ｢개인정보 보호법｣ 제35조에 따른 개인정보의 열람 청구를 아래의
              부서에 할 수 있습니다. {"<"} 파이브이얼즈 {">"}은(는) 정보주체의
              ...
              <br />
              제12조(개인정보 처리방침 변경)
              <br />① 이 개인정보처리방침은 2022년 5월 4부터 적용됩니다.{" "}
            </text>
          </Scrollbars>
        </ContentsDetail>
      </TermContents>
