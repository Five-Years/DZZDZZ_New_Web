    ...
    <>
      <PurchasePageContainer theme = {theme}>
        ...
        <PurchasingBoxContainer>
          ...
          </PurchasingCardTicket>modify
              </MyTicket>
              <BuyTicket>
                <TicketContainer><TicketImage><img src={require("../../../assets/ticket1.png")} alt="이미지" /></TicketImage><TicketCount><text>티켓 1개</text></TicketCount><TicketPrice><text>1,500 </text><img src={require("../../../assets/won.png")} alt="이미지" /></TicketPrice><TicketButton onClick={()=> {window.ReactNativeWebView?.postMessage(JSON.stringify({type : "buy", data : "1"}))}}><text>구매</text></TicketButton></TicketContainer>
