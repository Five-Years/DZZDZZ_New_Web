        ...
        <PurchasingBoxContainer>
          <PurchasingBox>
            ...
            <text>현재 보유 티켓 : {Ticket}</text>
              ...
              <BuyTicket>
                <TicketContainer><TicketImage><img src={require("../../../assets/ticket1.png")} alt="이미지" /></TicketImage><TicketCount><text>티켓 1개</text></TicketCount><TicketPrice><text>1,500 </text><img src={require("../../../assets/won.png")} alt="이미지" /></TicketPrice><TicketButton onClick={() => {dispatch(StateSlice.actions.Ticket());
            }}><text>구매</text></TicketButton></TicketContainer>
                <TicketContainer><TicketImage><img src={require("../../../assets/ticket2.png")} alt="이미지" /></TicketImage><TicketCount><text>티켓 5개</text><text className="bonus">4개 + 보너스 1개</text></TicketCount><TicketPrice><text>6,000 </text><img src={require("../../../assets/won.png")} alt="이미지" /></TicketPrice><TicketButton><text>구매</text></TicketButton></TicketContainer>
